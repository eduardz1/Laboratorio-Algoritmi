...
bissort <- data.frame(time = fpp[fpp$file == "es1_dataset/records.csv" & fpp$size, ]$time,
                      size = fpp[fpp$file == "es1_dataset/records.csv" & fpp$size, ]$size,
                      binarySearch = fpp[fpp$file == "es1_dataset/records.csv" & fpp$size, ]$binary_search)
